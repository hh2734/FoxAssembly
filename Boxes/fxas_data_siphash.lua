-- Error in library: fxas.data.siphash >
-- FoxBox version: 2.1
-- fox.lua version: 1.0
-- Unix time: 1768587011
...
local Box = {}
Box._config = {
	package = "fxas.data.siphash", -- Your package name
	version = 1.0, -- fxas.data.siphash version
	deps = nil
}
--> ============   CONFIG   ============ <--
