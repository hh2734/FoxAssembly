-- Error in library: fxas.data.md5 >
-- FoxBox version: 2.13
-- fox.lua version: 1.1
-- Unix time: 1768654524
...
local Box = {}
Box._config = {
	package = "fxas.data.md5", -- Your package name
	version = 1.0, -- fxas.data.md5 version
	deps = nil
}
--> ============   CONFIG   ============ <--
